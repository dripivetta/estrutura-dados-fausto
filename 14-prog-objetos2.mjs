/*
    ...
    algumas características aos objetos que serão criados a partir dela, embora outra característica
    dos objetos possam variar.
 */
// Por convenção, nome de classes em JS se iniciam com Letras Maiúsculas

class FormaGeometrica {
    // Declaração dos atributos privados
    #base // pode iniciar ela com alguma valor = 0
    #altura
    #tipo // = 'Q'
    ...
    // um novo objeto a partir da classe. No constructor (), podem ser feita validações
    ...
    constructor (base, altura, tipo) {
        ...
        // Invogar os setters das propriedades. As validações serão feitas por lá
        this.base = base
        this.altura = altura
        this.tipo = tipo
        ...
        // escopo do objeto criado a partir da classe. Essas variáveis especiais são denominadas ATRIBUTOS e diferenciam-se 
        // das variáveis comuns pela presença do prefixo this.
        ...
        // sejam adicionados ao objeto após sua criação
        Object.seal(this)
    ...
    */
    ...
    /*
        ...
        atributo privado. Em vez disso, calcula "ao vivo" um valor e o retorna
    */
    get area () {
        switch(this.tipo) { // pode ser com ou ser #tipo
            case 'Q':
    ...
    /*
        ...
        atributos privados, caso o novo valor esteja de acordo com as regras de negócio.
    */
    ...
    */
    ...
    /******************************************/
    // Função, dentro de classe, passam ser denominadas MÉTODOS e perdem a palavra function
    calcularArea () {
        switch(this.tipo) { // pode ser com ou ser #tipo
            case 'Q':
                return this.base * this.altura
...
try {
    ...
    // Tratamento de exceção. Nessa caso, simplismente exibiremos a mensagem de erro.
    console.log('ERRO:' + erro.message)
}

try { // TENTA executar as linhas contidas
    // Se acontecer alguam excessão no bloco try, a excecução é desviada para o bloco catch
...
//forma1.base = 'aksdfasdfadf' // Não funcionar

console.log('calculaArea() de forma1 (método):', forma1.calcularArea())
