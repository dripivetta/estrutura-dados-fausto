/*
    ...
    4. Teste o algoritmo no arquivo dados/candidatos-2018.msj, ordenando primeiramente
...
// SELECTION SORT
const a = (b, fnComp) => {
    const c = (d, e) => { // não precisa novamente passar o vetor d, porém substitui pelo b
        let f = e
    ...
    for (let h = 0; h < b.length -1; h++){
        let i = c(b, h +1) // se não usar o vetor d, não passar o b nesta parte
