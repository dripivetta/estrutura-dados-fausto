/*
    ...
    de enfileiramento (insertFront/insertBack) e desenfileiramento (removeFront/removeBack), 
    acontecendo em qualquer uma das extremidades da estrutura.
    - Como consequência, o deque NÃO SEGUE o principio FIFO (First In, First Out)
    primeiro a entrar, primeiro a sair.
    - A principal aplicação das filas são situações em que filas precisam aceitar
